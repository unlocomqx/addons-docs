  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/productdesigner/": [
        ...
        {
          title: "Configuration",
          path: "/productdesigner/03-configuration",
          collapsable: true,
          children: [
            "03-configuration/interface-options.md",
            "03-configuration/print-settings.md",
            "03-configuration/design-options.md",
            "03-configuration/text-options.md",
            "03-configuration/image-options.md",
            "03-configuration/tabs.md",
            "03-configuration/sides.md",
            "03-configuration/colors.md",
            "03-configuration/fonts.md",
            "03-configuration/image-groups.md",
            "03-configuration/images.md",
